...
export default function Home() {
  return (
    ...
    Just two months into their relationship, the world was hit by the COVID-19 pandemic, bringing everything to a standstill.
    However, for Gerard and Bria, this time of isolation became an opportunity to deepen their bond, and they fell in love amidst the uncertainty. In August 2020, they each embarked on their own educational paths. Gerard earned an Associate degree in Business Leadership along with a certificate in Web Development, while Bria attained her degree as a Physical Therapist Assistant. 
    Through the highs and lows, they have stood by each other’s side for five years by remaining strong in their love, faith, and trust in God. Despite growing up with very different backgrounds, Gerard and Bria have come to appreciate and learn from each other’s differences, making their relationship even more beautiful. As they step into this next chapter of their lives, Gerard and Bria are filled with excitement for the future filled with even more love, shared memories, family, and faith. 
    They are so grateful to have you celebrate with them! Join us in celebrating the union of Gerard and Bria as they begin this beautiful new chapter together.</p>
