...
export default function Home() {
  return (
    <div className={styles.page}>
      ...
      <div className={styles.title}><h1>OUR STORY</h1></div>
      
      <Image className={styles.photo} src= "/images/mainengagement.jpg" alt="loving photo of Bria and Gerard" width={300} height={300}/>
